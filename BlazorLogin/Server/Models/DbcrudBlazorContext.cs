...
namespace BlazorLogin.Server.Models;
...
public partial class DbcrudBlazorContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdDepartamento).HasName("PK__Departam__787A433DB55ACAE5");
        ...
        {
            entity.HasKey(e => e.IdEmpleado).HasName("PK__Empleado__CE6D8B9EB7A58C54");
